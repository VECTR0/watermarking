...
class CustomConvNeXt(nn.Module, PyTorchModelHubMixin):
    ...
    def __init__(self, ckpt_path=None, device=None):
        ...
        # TODO secret size = 16 hardcode - nie wiem nawet ile to ma byc xdd mozna sparametryzowac i przetestowac
        self.convnext.classifier.append(nn.Linear(in_features=1000, out_features=16, bias=True))
